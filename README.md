...
* Происходит слежение за ценами посредством изучения информации, приходящей по свечам с заданным в параметрах интервалом.
За текущуюю цену берётся средняя цена свечи.
* В процессе слежения за ценой имитируются механизмы наподобие стоп-лоссов и тейк-проифитов.
